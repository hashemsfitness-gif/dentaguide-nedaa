...
export const lakemedelData: DrugData[] = [
  {
    ...
    viktigt: [
      ...
      { typ: 'yellow', text: ' Vid INR mellan 1,3 och 2,0 har pat även påverkad koagulation! ' },
  ...
  },
  {
    ...
    behandlingar: [
      ...
      { typ: 'avoid', label: 'Sälj NSAID', text: 'Undvik NSAID — adderar blödningsrisk via trombocythämning.' },
    ],
    viktigt: [
  ...
  },
  {
    ...
    summary: ['✓ Sätt ALDRIG ut inom 12 mån efter koronartstent', '✓ Enkel extraktion möjlig utan utsättning', '⚠️ Dubbel hämning: lokal hemostas extra viktigt'],
    ...
    behandlingar: [
      ...
      { typ: 'avoid', label: 'Utsättning inom 12 mån efter stent', text: 'LIVSFARA — stenttrombos. Sätt ALDRIG ut utan kardiologbeslut. Vänta om möjligt med elektiv tandvård.' },
      { typ: 'avoid', label: 'NSAID parallellt', text: 'Additiv trombocythämning → ökad blödningsrisk. Välj paracetamol.' },
    ],
    viktigt: [
      { typ: 'red', text: 'ALDRIG sätta ut ASA/klopidogrel inom 12 månader efter PCI/stent — livshotande stenttrombos' },
      ...
      { typ: 'yellow', text: 'Nyinsatt stent (<6 månader): skjut upp elektiv tandvård om möjligt' },
      { typ: 'green', text: 'Enkel extraktion: genomförbar utan utsättning med lokal hemostas' },
      { typ: 'blue', text: 'Vänta minst 6 månader (helst 12) efter stent med elektiv oral kirurgi' },
    ],
    interaktioner: [
  ...
  },
  {
    ...
    behandlingar: [
      { typ: 'ok', label: 'Parodontal behandling (supragingival)', text: 'Säkert. Aviod djup subgingival behandling vid hög-dos Intravenös-behandling.' },
  ...
  },
  {
    ...
    behandlingar: [
      ...
      { typ: 'ok', label: 'Extraktion / Kirurgi (välkontrollerad DM)', text: 'Genomförbar. HbA1c <70 mmol/mol. Normal läkning förväntas.' },
      { typ: 'caution', label: 'Kirurgi (dålig glukoskontroll)', text: 'HbA1c >70–80 mmol/mol: ökad infektionsrisk och fördröjd läkning. Planera med läkare. Antibiotikaprofylax kan vara motiverat.' },
    ...
    viktigt: [
      ...
      { typ: 'green', text: 'Välkontrollerad DM (HbA1c <70): normal tandvård utan extra åtgärder' },
