...
export const protetikScenarier: Record<string, ProtetikScenario> = {
  "lossnad-tillfallig-krona": {
    ...
    scId: "PROT-15-PROV",
    icd: "Z46.3 (Justering tandprotes) / K08.5 (Ofullständig tandfunktion)",
...
Info: Om det lossnar igen bör skruven bytas.`,
  ...
  "fraktur-stodtand": {
    ...
    icd: "S02.5 (Kron-rotfraktur) / K08.5 (Ofullständig tandfunktion)",
...
Åb om ej bra om 1 vecka.`,
  ...
  "fraktur-protes": {
    ...
    icd: "K08.5 (Ofullständig tandfunktion) / Z46.3 (Justering tandprotes)",
...
(ha vatten i handfatet eller handduk under för att dämpa fall).`,
  ...
  "porslinsfraktur": {
    ...
    scId: "PROT-20-CHIP",
    icd: "K08.5 (Ofullständig tandfunktion) / T85.6 (Mekanisk komplikation — implantat)",
...
Vid recidiv rekommenderas ny krona.`,
  ...
  "lossnad-krona": {
    slug: "lossnad-krona",
    scId: "PROT-21-LOSSKR",
    icd: "K08.5 (Ofullständig tandfunktion)",
