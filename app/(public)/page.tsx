...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#062f40] text-slate-100 font-sans selection:bg-[#CC5833] selection:text-white">
      {/* BACKGROUND GRAIN OVERLAY */}
      <div className="pointer-events-none fixed inset-0 z-50 opacity-10 mix-blend-overlay bg-[url('https://grainy-gradients.vercel.app/noise.svg')]"></div>

      {/* NAVIGATION */}
      <header className="sticky top-0 z-40 w-full backdrop-blur-md bg-[#062f40]/80 border-b border-white/5">
        <div className="container mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Image
              ...
              width={40}
              height={40}
              className="mix-blend-screen brightness-200"
            />
            <span className="font-serif italic text-2xl tracking-wide text-white">
              DentaGuide<span className="text-[#CC5833] font-sans not-italic text-sm align-top ml-1">PRO</span>
            </span>
          </div>
          
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-300">
            <Link href="#verktyg" className="hover:text-[#CC5833] transition-colors">Verktyg</Link>
            <Link href="#priser" className="hover:text-[#CC5833] transition-colors">Priser</Link>
            <Link href="/om-oss" className="hover:text-[#CC5833] transition-colors">Klinisk Data</Link>
          </nav>

          <div className="flex items-center gap-4">
            <Link href="/login" className="text-sm font-medium hover:text-white transition-colors">Logga in</Link>
            <Button className="bg-[#CC5833] hover:bg-[#b04a29] text-white rounded-full px-6 border-none">
              Kom igång
            </Button>
          </div>
        </div>
      ...
      <main ref={containerRef}>
        {/* HERO SECTION */}
        <section className="relative pt-24 pb-32 overflow-hidden bg-gradient-to-b from-[#0d4a65] to-[#062f40]">
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-10 z-10">
                <h1 className="font-serif text-5xl md:text-7xl leading-tight text-white">
                  ...
                  <motion.span 
                    ...
                    className="italic inline-block relative bg-gradient-to-r from-[#CC5833] via-[#ff9c7a] to-[#CC5833] bg-[length:200%_auto] bg-clip-text text-transparent"
                  >
                    när det gäller.
                  </motion.span>
                </h1>
                ...
                <div className="flex flex-wrap gap-4">
                  <Button className="bg-[#CC5833] hover:bg-[#b04a29] text-white rounded-full px-8 py-6 text-lg border-none shadow-lg shadow-[#CC5833]/20">
                ...
                <div className="grid grid-cols-3 gap-6 pt-8 border-t border-white/10">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 uppercase tracking-wider mt-1">Scenarier</p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-white">26</p>
                    <p className="text-xs text-slate-400 uppercase tracking-wider mt-1">Kliniska verktyg</p>
                  </div>
                  <div>
                    <p className="text-3xl font-bold text-[#CC5833]">98%</p>
                    <p className="text-xs text-slate-400 uppercase tracking-wider mt-1">Dokumenterad precision</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative flex justify-center items-center z-10">
                <div className="relative w-full max-w-md aspect-square rounded-3xl overflow-hidden border border-white/10 bg-[#0d4a65]/50 shadow-2xl group">
                  <video 
                    autoPlay 
                    loop 
                    muted 
                  ...
                  <motion.div 
                    ...
                    className="absolute -bottom-6 -left-6 bg-white text-[#0F1A14] p-4 rounded-2xl shadow-xl flex items-center gap-3 max-w-[200px]"
                  >
        ...
        {/* MARQUEE TICKER */}
        <div className="w-full bg-[#CC5833] py-4 overflow-hidden flex whitespace-nowrap">
          <motion.div 
            animate={{ x: ["0%", "-50%"] }}
        ...
        <section id="verktyg" className="py-32 bg-[#f4f7f6] text-[#062f40]">
          <div className="container mx-auto px-6 max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
              {[
                ...
                { icon: "📏", title: "Ortodonti", desc: "Interceptionella och ortodontiska bedömningar i allmäntandvård." }
              ].map((domain, i) => (
                <div 
                  key={i} 
                  className={`p-8 rounded-3xl border shadow-sm hover:shadow-md transition-all group cursor-pointer ${
                    i === 5 
                      ? 'bg-[#FFF9F6] border-[#FFB59F] hover:border-[#FF7E55]' 
                      : 'bg-white border-slate-100 hover:border-[#CC5833]/30'
                  }`}
                >
                  <div className="text-3xl mb-4 opacity-80 group-hover:scale-110 transition-transform origin-left">{domain.icon}</div>
                  <h3 className="font-serif text-2xl mb-2 text-[#062f40]">{domain.title}</h3>
            ...
            <div className="bg-[#1E3028] rounded-3xl p-0 overflow-hidden flex flex-col md:flex-row relative group hover:shadow-xl transition-all border border-[#1E3028]">
              <div className="p-10 md:p-14 md:w-1/2 flex flex-col justify-center text-white z-10">
                <span className="bg-[#FF7E55] text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-full w-max mb-6">Uppgraderad</span>
                <h3 className="font-serif text-4xl mb-4 text-white">Pedodonti & Ungdom</h3>
                <p className="text-[#FFDBD0] text-sm leading-relaxed mb-8 max-w-sm opacity-90">
                  Särskilt anpassade riktlinjer för barn- och ungdomsthandvård med fokus på beteendehantering och interceptiv ortodonti.
                </p>
                <Link href="#" className="text-[#FFB59F] font-bold text-sm tracking-wide flex items-center gap-2 hover:gap-4 transition-all">
                  LÄS MER <span>→</span>
                </Link>
              </div>
              <div className="md:w-1/2 relative bg-[#091B14]/30 flex items-center justify-center p-8 overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-tr from-[#FFB59F]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-r-3xl"></div>
                <img 
                  src="/characters/pedodonti_character.png" 
          ...
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 auto-rows-[250px]">
              ...
              <div className="flex flex-col gap-6">
                {/* Diagnoshjälp med think.gif */}
                <div className="bg-white rounded-3xl p-8 flex-1 relative overflow-hidden border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
                  <h3 className="font-serif text-2xl text-[#062f40] mb-2">Diagnoshjälp</h3>
                  <p className="text-xs text-slate-500 mb-6">Kognitivt beslutsstöd i realtid.</p>
                  
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-center justify-between">
                     <div>
                       <p className="text-[10px] text-slate-400 uppercase font-bold">Input-symtom</p>
                       <p className="text-sm font-semibold text-[#0d4a65]">Irreversibel Pulpit</p>
                     </div>
                ...
                {/* Synkade Riktlinjer */}
                <div className="bg-white rounded-full p-6 flex items-center justify-between border border-slate-200 shadow-sm hover:border-[#CC5833]/50 transition-colors cursor-pointer">
                  <div className="flex items-center gap-3">
                    <div className="w-3 h-3 bg-red-500 rounded-full animate-ping"></div>
                    <span className="text-sm font-bold text-[#062f40]">Synkade Riktlinjer</span>
                  </div>
              ...
              <div className="bg-[#0F1A14] rounded-3xl p-8 text-green-400 lg:col-span-1 lg:row-span-2 font-mono flex flex-col relative shadow-xl overflow-hidden">
                ...
                <div className="space-y-4 text-xs leading-relaxed opacity-80 flex-1">
                  ...
                  <p className="text-[#CC5833]">Röntgen: Vidgad periapikal spalt 36...</p>
              ...
              <div className="bg-white rounded-3xl p-8 lg:row-span-2 border border-slate-200 shadow-sm flex flex-col">
                ...
                <h3 className="font-serif text-3xl text-[#062f40] mb-8">SOP <span className="italic text-slate-400">&</span> Trauma</h3>
                ...
                <div className="bg-[#0d4a65] text-white p-4 rounded-2xl flex items-center gap-4 mt-6 cursor-pointer hover:bg-[#062f40] transition-colors">
        ...
        <section className="py-32 bg-[#062f40] relative">
          <div className="container mx-auto px-6">
            <div className="text-center mb-24">
              <h2 className="font-serif text-4xl md:text-5xl text-white">Ett flöde för <span className="text-[#CC5833] italic">hela processen.</span></h2>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-12 pb-32">
              <div className="sticky top-28 bg-white p-12 md:p-16 rounded-[40px] shadow-xl border border-slate-100 mb-24 transition-transform duration-500">
                ...
                <h3 className="font-serif text-5xl text-[#062f40] mb-6">ParodKlassificerare</h3>
              ...
              <div className="sticky top-32 bg-slate-50 p-12 md:p-16 rounded-[40px] shadow-xl border border-slate-200 mb-24">
                ...
                <h3 className="font-serif text-5xl text-[#062f40] mb-6">AntibiotikaTool</h3>
                <p className="text-lg text-slate-500 leading-relaxed max-w-xl">
              ...
              <div className="sticky top-36 bg-white p-12 md:p-16 rounded-[40px] shadow-2xl border border-slate-200 mb-24">
                ...
                <h3 className="font-serif text-5xl text-[#062f40] mb-6">DoseringKalkylator</h3>
                <p className="text-lg text-slate-500 leading-relaxed max-w-xl">
              ...
              <div className="sticky top-40 bg-[#0d4a65] p-12 md:p-16 rounded-[40px] shadow-2xl border border-[#062f40] text-white">
                <div className="flex justify-between items-start mb-8">
                ...
                <Button className="bg-[#CC5833] hover:bg-[#b04a29] text-white rounded-full px-8 py-6">
                  Utforska Verktygen
                </Button>
              </div>
            </div>
        ...
        {/* FARMAKOLOGISKT STÖD */}
        <section className="py-24 bg-[#0F1A14] text-white border-t border-white/5">
          <div className="container mx-auto px-6 max-w-7xl">
            ...
            <div className="flex overflow-x-auto pb-12 gap-6 snap-x hide-scrollbar" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              {featuredDrugs.map((drug) => (
                <div 
                  key={drug.id} 
                  className="group min-w-[320px] bg-white/5 border border-white/10 p-8 rounded-[24px] snap-start transition-all duration-300 hover:-translate-y-2 hover:bg-white/10 hover:border-[#CC5833] hover:shadow-[0_8px_30px_rgba(204,88,51,0.15)] cursor-pointer flex flex-col justify-between min-h-[240px]"
                >
                  <div>
                    <span className="text-[10px] text-[#CC5833] font-bold tracking-widest uppercase mb-4 block">
                      {drug.cat}
                    </span>
                  ...
                  <div className="flex justify-between items-center mt-6 pt-5 border-t border-white/10 transition-colors duration-300 group-hover:border-[#CC5833]/30">
                    <span className="text-[10px] text-slate-400 uppercase font-bold tracking-widest group-hover:text-white transition-colors">
                      Klinisk Data
                    </span>
                    <span className="text-slate-500 group-hover:text-[#CC5833] group-hover:translate-x-1 transition-all">
                      →
                    </span>
                  </div>
                </div>
        ...
        {/* PRISSÄTTNING */}
        <section id="priser" className="py-32 bg-[#f4f7f6]">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-16">
              <h2 className="font-serif text-5xl text-[#062f40] mb-4">Prisplaner för kliniken</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
              ...
              <div className="bg-white p-10 rounded-[30px] border border-slate-200 text-center shadow-sm">
                ...
                <h3 className="font-serif text-3xl text-[#062f40] my-2">Klinik Bas</h3>
                <div className="my-6">
                  <span className="text-5xl font-bold text-[#062f40]">0 kr</span>
              ...
              <div className="bg-[#0F1A14] p-10 rounded-[30px] border border-[#CC5833]/50 text-center shadow-2xl relative transform scale-105 z-10">
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-[#CC5833] text-white text-[10px] font-bold uppercase tracking-widest px-4 py-1 rounded-full">Mest populär</div>
                ...
                <ul className="text-sm text-slate-300 space-y-4 mb-8 text-left">
                  <li className="flex items-center gap-3"><span className="text-[#CC5833]">✓</span> Alla klinikfunktioner</li>
                  <li className="flex items-center gap-3"><span className="text-[#CC5833]">✓</span> Fullständig farmakologi</li>
                  <li className="flex items-center gap-3"><span className="text-[#CC5833]">✓</span> Digitala status-karta</li>
                  <li className="flex items-center gap-3"><span className="text-[#CC5833]">✓</span> Smart journalmall-export</li>
                </ul>
                <Button className="w-full bg-[#CC5833] hover:bg-[#b04a29] text-white rounded-full">Välj Pro</Button>
              </div>

              <div className="bg-white p-10 rounded-[30px] border border-slate-200 text-center shadow-sm">
                <span className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">Kliniknätverk</span>
                <h3 className="font-serif text-3xl text-[#062f40] my-2">Klinik Team</h3>
                <div className="my-6">
                  <span className="text-5xl font-bold text-[#062f40]">799 kr</span>
                  <span className="text-slate-500 text-sm"> / mån</span>
                </div>
                <ul className="text-sm text-slate-600 space-y-4 mb-8 text-left">
      ...
      {/* FOOTER */}
      <footer className="bg-[#0F1A14] pt-20 pb-10 border-t border-white/10 text-slate-400">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-2 mb-6">
                <Image src="/logo/hexagon-2.png" alt="Logo" width={24} height={24} className="mix-blend-screen brightness-200"/>
                <span className="font-serif italic text-xl text-white">DentaGuide<span className="text-[#CC5833] font-sans not-italic text-xs align-top ml-1">PRO</span></span>
              </div>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input type="email" placeholder="Din e-post" className="bg-white/5 border border-white/10 rounded-full px-4 py-2 text-sm w-full focus:outline-none focus:border-[#CC5833]" />
                <Button className="bg-[#CC5833] hover:bg-[#b04a29] text-white rounded-full px-4">Prenumerera</Button>
              </div>
            </div>
          </div>
